...
export const View = () => {
	...
	const handleToolip = (e) => {
		...
		div.style.left =
			coords.left - (div.offsetWidth - e.target.offsetWidth) / 2 + "px";
	...
	return (
		<div className="contacts">
			...
			<p>
				Most contacts ({statistics.mostGender}): {statistics.most}{" "}
			</p>
			<p></p>
			<Pagination
				defaultCurrent={1}
			...
			<article className={error + " contacts__error"}>
				<p>
					<ExclamationCircleOutlined /> Error, try to reload!{" "}
				</p>
				<ReloadOutlined onClick={fetchRequest} />
			</article>
		</div>
